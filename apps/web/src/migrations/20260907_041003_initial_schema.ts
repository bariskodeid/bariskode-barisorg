...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_courses_level" AS ENUM('pemula', 'menengah', 'lanjutan');
  CREATE TYPE "public"."enum_courses_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__courses_v_version_level" AS ENUM('pemula', 'menengah', 'lanjutan');
  ...
  CREATE TABLE "courses" (
  	...
  	"category_id" integer,
  	"level" "enum_courses_level" DEFAULT 'pemula',
  ...
  CREATE TABLE "_courses_v" (
  	...
  	"version_level" "enum__courses_v_version_level" DEFAULT 'pemula',
  ...
  CREATE TABLE "lessons" (
  	...
  	"sandbox_language" varchar,
  	"sandbox_starter_code" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "posts" ADD CONSTRAINT "posts_related_course_id_courses_id_fk" FOREIGN KEY ("related_course_id") REFERENCES "public"."courses"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v" ADD CONSTRAINT "_posts_v_version_related_course_id_courses_id_fk" FOREIGN KEY ("version_related_course_id") REFERENCES "public"."courses"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "user_lesson_idx" ON "progress" USING btree ("user_id","lesson_id");
  CREATE UNIQUE INDEX "posts_slug_idx" ON "posts" USING btree ("slug");
  CREATE INDEX "posts_featured_image_idx" ON "posts" USING btree ("featured_image_id");
  CREATE INDEX "posts_author_idx" ON "posts" USING btree ("author_id");
  CREATE INDEX "posts_related_course_idx" ON "posts" USING btree ("related_course_id");
  ...
  CREATE INDEX "_posts_v_version_version_related_course_idx" ON "_posts_v" USING btree ("version_related_course_id");
