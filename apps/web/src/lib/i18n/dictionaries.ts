...
const id = {
  ...
  settings: {
    title: 'Pengaturan',
    subtitle: 'Kelola profil dan akun kamu.',
    tabs: {
      profile: 'Profil',
      password: 'Password',
    },
    profile: {
      name: 'Nama',
      nameDesc: 'Nama tampil yang terlihat di profil publik.',
      email: 'Email',
      emailDesc: 'Email untuk login dan notifikasi.',
      bio: 'Bio',
      bioDesc: 'Ceritakan sedikit tentang dirimu.',
      bioPlaceholder: 'Siswa yang tertarik dengan...',
      avatar: 'Avatar',
      avatarDesc: 'Foto profil kamu. Format: JPG, PNG, atau WebP.',
      ...
      maxSizeError: 'Ukuran file maksimal 5MB.',
    },
    password: {
      current: 'Password Saat Ini',
      currentDesc: 'Masukkan password yang sedang kamu pakai.',
      newPass: 'Password Baru',
      newPassDesc: 'Minimal 8 karakter.',
      confirm: 'Konfirmasi Password Baru',
      confirmDesc: 'Ulangi password baru kamu.',
      save: 'Ubah Password',
      saving: 'Mengubah...',
      success: 'Password berhasil diubah.',
      error: 'Gagal mengubah password.',
      mismatch: 'Konfirmasi password tidak cocok.',
      wrongPassword: 'Password saat ini salah.',
...
const en: typeof id = {
  ...
  settings: {
    ...
    profile: {
      name: 'Name',
      nameDesc: 'Display name shown on your public profile.',
      email: 'Email',
      emailDesc: 'Email used for login and notifications.',
      bio: 'Bio',
      bioDesc: 'Tell others a little about yourself.',
      bioPlaceholder: 'A student interested in...',
      avatar: 'Avatar',
      avatarDesc: 'Your profile picture. Formats: JPG, PNG, or WebP.',
      ...
      maxSizeError: 'File size must be under 5MB.',
    },
    password: {
      current: 'Current Password',
      currentDesc: 'Enter your current password.',
      newPass: 'New Password',
      newPassDesc: 'At least 8 characters.',
      confirm: 'Confirm New Password',
      confirmDesc: 'Repeat your new password.',
